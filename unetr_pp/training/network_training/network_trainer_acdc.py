...
class NetworkTrainer_acdc(object):
    def __init__(self, deterministic=True, fp16=False):
        ...
        self.max_num_epochs = 5   #  修改为 1000->1 ，测试程序能否跑通
        self.num_batches_per_epoch = 250   #250->25
        self.num_val_batches_per_epoch = 50  # 50->5
    ...
    def maybe_update_lr(self):
        ...
        if self.lr_scheduler is not None:
            ...
            if isinstance(self.lr_scheduler, lr_scheduler.ReduceLROnPlateau):
                # lr scheduler is updated with moving average pred_pp loss. should be more robust
